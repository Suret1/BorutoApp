...
import com.suret.borutoapp.domain.model.OnBoardingPage
import com.suret.borutoapp.navigation.Screen
import com.suret.borutoapp.ui.theme.*
import com.suret.borutoapp.util.Constants.LAST_ON_BOARDING_PAGE
import com.suret.borutoapp.util.Constants.ON_BOARDING_PAGE_COUNT
...
fun WelcomeScreen(
    ...
    welcomeVM: WelcomeVM = hiltViewModel()
) {
    val pages = listOf(
    ...
    Column(
        ...
        FinishButton(
            ...
            welcomeVM.saveOnBoardingState(completed = true)
        }
    }
}
...
@Composable
fun FirstOnBoardingDarkPreview() {
    Column(modifier = Modifier.fillMaxSize()) {
        PagerScreen(onBoardingPage = OnBoardingPage.First)
    }
}
...
@Preview(showBackground = true, uiMode = UI_MODE_NIGHT_YES)
@Composable
fun SecondOnBoardingDarkPreview() {
    Column(modifier = Modifier.fillMaxSize()) {
        PagerScreen(onBoardingPage = OnBoardingPage.Second)
    }
}
...
@Preview(showBackground = true, uiMode = UI_MODE_NIGHT_YES)
@Composable
fun ThirdOnBoardingDarkPreview() {
    Column(modifier = Modifier.fillMaxSize()) {
        PagerScreen(onBoardingPage = OnBoardingPage.Third)
    }
}