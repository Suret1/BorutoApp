...
//        Timber.d("RemoteMediator CurrentTime : ${parseMillis(currentTime)}")
//        Timber.d("RemoteMediator LastUpdatedTime :  ${parseMillis(lastUpdated)}")

        val diffInMinutes = (currentTime - lastUpdated) / 1000 / 60
        return if (diffInMinutes.toInt() <= cacheTimeout) {
//            Timber.d("RemoteMediator UP TO DATE")
