...
class RatingWidgetTest {
    ...
    @Test
    fun passZeroPointFiveValue_Assert_FourEmptyStars_and_OneHalfFilledStars() {
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 0.5
    ...
    @Test
    fun passZeroPointSixValue_Assert_FourEmptyStars_and_OneFilledStars() {
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 0.6
    ...
    @Test
    fun passFourPointZeroValue_Assert_FourFilledStars_and_OneEmptyStars() {
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 4.0
    ...
    @Test
    fun passFourPointThreeValue_Assert_FourFilledStars_and_HalfFilledStars() {
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 4.3
